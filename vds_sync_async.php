...
// 3. Registrar a data da última sincronização com sucesso no banco de dados local
...
echo json_encode([
    ...
    'message' => ($resSync['count'] ?? 0) > 0 ? "{$resSync['count']} novo(s) chamado(s) sincronizado(s) da VDS!" : "Sincronização em segundo plano concluída com a VDS.",
    'items' => $items
