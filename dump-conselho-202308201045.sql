...
CREATE TABLE `fase` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='enumera as fases do recurso';
...
INSERT INTO `fase` VALUES (1,'Novo');
...
INSERT INTO `recurso` VALUES (1,307,'A','510/2023','-',1,'naramicaelledesousa@gmail.com','Nara Micaelle','Prezados bom dia!\r\n\r\nRecebemos a advertência , porém, na data de hoje foi instalado a rede','Instalação de Telas','2023-08-04');
...
INSERT INTO `usuarios` VALUES (5,'davi.nunes@gmail.com','e8788d2f60d0207d220909e095a2ac781e640290880c0f7870dde2752dbbc15a','DAVI NUNES DE FRANCA',1,'104E');
...
-- Dump completed on 2023-08-20 10:45:55
