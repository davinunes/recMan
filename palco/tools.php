...
$tools = [
    'Recursos e Pareceres' => [
        ...
        ['label' => 'Ambiente de Testes Typst 5050', 'url' => 'palco/test_typst.php', 'icon' => 'science', 'target' => '_blank', 'color' => 'teal darken-1'],
    ],
    'Sincronização' => [
...
<div class="container-fluid" style="padding: 0 15px;">
    <div class="row" style="margin-top: 20px;">
        <div class="col s12">
            ...
            <p class="grey-text">Acesse as ferramentas administrativas, utilitários e configurações do sistema.</p>
        </div>
    </div>
