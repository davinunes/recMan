        ...
        cardsHtml += `
            <div class="col s12 m6 l3">
                <div class="card-panel white center-align z-depth-1 hoverable" style="${cardStyle}">
                    ...
                    <div style="font-weight:bold; font-size:1.05rem; color:${isAtivo ? '#1a237e' : '#546e7a'}; margin-bottom:2px;" class="truncate" title="${descVeiculo}">${descVeiculo}</div>
                    ${propStr}
                    ${pcdBadge}
                    ${inativoBadge}
                    ${obsStr}
